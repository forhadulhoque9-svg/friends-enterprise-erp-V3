        ...
        <div className="space-y-4">
          <table className="w-full text-sm border-collapse">
            <tbody>
              ...
              <tr>
                <td className="py-2 border-b border-slate-300 font-bold">(+) কোম্পানি ইনসেন্টিভ ও স্কিম জমা (Incentive & Claims)</td>
...
// Now we need to close the normal view div at the end.
// Since the return statement ends with:
//         </div>
//       )}
//     </div>
//   );
